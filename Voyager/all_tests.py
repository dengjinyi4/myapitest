...
# to_list=['dengjinyi@emar.com','aidinghua@emar.com','wangzhanyu@emar.com','mashilong@emar.com','chaobin@emar.com','jishenghui@emar.com','wanglanqing@emar.com']
to_list=['dengjinyi@emar.com']
Emar_SendMail_Attachments.sendTestreport(sendfilename,to_list,'互动推api','测试报告')
