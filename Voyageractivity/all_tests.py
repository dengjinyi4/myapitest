...
filename = 'D:/work/auto/Voyageractivity/report/Report%s.html' %(t)
fp = file(filename, 'wb')
...
fp.close()
sendfilename='D:/work/auto/Voyageractivity/report/Report%s.html'%t
to_list=['dengjinyi@emar.com','aidinghua@emar.com','wangzhanyu@emar.com','wanglanqing@emar.com','mashilong@emar.com','chaobin@emar.com','jishenghui@emar.com','wangzhanyu@emar.com']
# to_list=['dengjinyi@emar.com']
Emar_SendMail_Attachments.sendTestreport(sendfilename,to_list,'互动推UI-活动测试报告','测试报告')
