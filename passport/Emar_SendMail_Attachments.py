...
if __name__ == '__main__':
	to_list=['aidinghua@emar.com']
	sendTestreport("D:/work/python/egouapi/report/Report2016-07-26-16-21.html",to_list,'易购api自动化测试报告','</pre><h1>你好</h1><pre>')